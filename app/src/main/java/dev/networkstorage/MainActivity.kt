...
private fun automaticSyncIntervalLabel(minutes: Long): String = when (minutes) { 15L -> "15m"; 60L -> "1h"; 360L -> "6h"; 1440L -> "24h"; else -> "${minutes}m" }
