...
class DownloadWorker @AssistedInject constructor(@Assisted context: Context, @Assisted params: WorkerParameters, private val cache: CacheRepository, private val credentials: CredentialStore) : CoroutineWorker(context, params) {
    override suspend fun doWork(): Result {
        ...
        return try {
            ...
            Result.success(Data.Builder().putString(KEY_URI, result.uri.toString()).putBoolean(KEY_REUSED, result.reused).putLong(KEY_EVICTED_BYTES, result.evictedBytes).build())
    ...
    companion object { const val KEY_CONNECTION="connection"; const val KEY_PATH="path"; const val KEY_COPIED="copied"; const val KEY_TOTAL="total"; const val KEY_URI="uri"; const val KEY_REUSED="reused"; const val KEY_EVICTED_BYTES="evicted_bytes"; const val KEY_ERROR="error"; const val CHANNEL="on-demand-downloads"; const val NOTIFICATION_ID=4104 }
}
